...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) supera el tamaño máximo permitido de carga de <b>{maxSize} KB</b>. Por favor, vuelva a intentar la subida!',
        msgFilesTooMany: 'El número de archivos seleccionados para la carga <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>. Por favor vuelva a intentar la subida!!',
        msgFileNotFound: 'El archivo "{name}" no se encuentra!',
        msgFileNotReadable: 'El archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'Vista previa del archivo abortado por "{name}".',
        msgFilePreviewError: 'Se produjo un error al leer el archivo "{name}".',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Error de carga de archivos</span>',
