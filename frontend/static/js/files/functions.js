$(function() {
	...
	oTable = $('.dTable').dataTable({
		...
		"oLanguage": {
			"sLengthMenu": "<span class='showentries'> Mostrar:</span> _MENU_"
		}
	});
	...
	$(document).bind('click', function(e) {
		var $clicked = $(e.target);
		if (! $clicked.parents().hasClass("Reports"))
		$(".Report").slideUp(200);
	});
	
	$('a.HomeBanking').click(function () {
		$('.HomeBank').slideToggle(200);
	});
	$(document).bind('click', function(e) {
		var $clicked = $(e.target);
		if (! $clicked.parents().hasClass("HomeBanking"))
		$(".HomeBank").slideUp(200);
	});
